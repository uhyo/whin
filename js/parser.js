...
LiveTokenList.prototype.iterate=function(mode,mode2){
	...
	if(!next && (this.str||this.length))throw new SyntaxError();
	this.last_iterate.push(lit);
	return next;
}
//iterateしたものを戻す
