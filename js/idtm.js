...
(function() {
  var Calc, Calc1, Calc2, Call, Charcode, Closure, Compiler, End, Func, FunctionStart, GlobalClosure, InputChar, InputNumber, IterationManager, JumpOperation, JumpifOperation, JumpunlessOperation, Label, Literal, NativeFunc, Operation, Print, ReturnOperation, SubstituteOperation, Variable, parser, _ref, _ref1,
  ...
  Compiler = (function() {
    ...
    Compiler.prototype.main = function(obj) {
      var backlabel, cond, cres, endlabel, exp, falselabel, nextlabel, tmpv, v, vararr, vari, _i, _len, _ref, _ref1, _ref2,
        _this = this;
      if (obj instanceof parser.BlockStatement) {
        ...
        if (obj.exp != null) {
          this.result.push(new ReturnOperation(this.calc(obj.exp)));
        } else {
    ...
    Compiler.prototype.makeFunction = function(func) {
      return new Func(func.name, func.paramlist, func.functionbody);
    };
  ...
  ReturnOperation = (function(_super) {
    ...
    function ReturnOperation(returnvalue) {
  ...
  Call = (function(_super) {
    ...
    function Call(func, args) {
      this.func = func;
      this.args = args;
      if (this.func instanceof Charcode || this.func instanceof InputChar || this.func instanceof InputNumber) {
        this.type = this.TYPE_NUMBER;
      }
    }
